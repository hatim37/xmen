...
final class Version20230325094137 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pays (id INT AUTO_INCREMENT NOT NULL, nationalite_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_349F3CAE1B063272 (nationalite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
